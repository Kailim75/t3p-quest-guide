    ...
    cards: [
      ...
      },
      {
        ...
        keyFigures: [
          ...
          { value: "3", label: "tarifs à Paris : A, B, C" },
        ],
        title: 'Tarifs 2026',
        essential: "3 tarifs à Paris (A, B, C) — pas de tarif D. Forfaits aéroports 2026 : CDG 56 €/65 €, Orly 45 €/36 €.",
        narrative: "Les tarifs du taxi parisien sont RÉGLEMENTÉS par arrêté préfectoral, contrairement aux VTC. Ils sont révisés chaque année et entrent en vigueur le 1er février (sauf exception). Pour 2026, l'arrêté du 24 décembre 2025 a fixé les nouveaux tarifs. La grille parisienne repose sur 3 lettres (A, B, C) qui correspondent chacune à une combinaison zone × horaire.\n\nLE TARIF A est le moins cher : Paris intra-muros, en JOUR (10h-17h), en SEMAINE (lundi-samedi hors jours fériés). C'est le tarif standard de la journée ouvrée. LE TARIF B s'applique à Paris la nuit (17h-10h), les dimanches en journée et les jours fériés — ou à la banlieue (petite couronne) en jour. LE TARIF C, le plus cher, couvre la nuit du dimanche à Paris, la banlieue de nuit et les dessertes au-delà de la zone. Le taximètre bascule automatiquement entre ces tarifs selon l'horaire et la position — le chauffeur n'intervient pas.\n\nATTENTION : le TARIF D N'EXISTE PAS à Paris. La grille à 4 lettres (A, B, C, D) est celle des taxis de PROVINCE, où D correspond au retour à vide de nuit. À l'examen parisien, une réponse « tarif D » est un piège.\n\nLes FORFAITS AÉROPORTS sont distincts et obligatoires pour les liaisons Paris ↔ CDG/Orly. Pour 2026 : Paris RIVE DROITE ↔ CDG = 56 € ; Paris RIVE GAUCHE ↔ CDG = 65 € (plus cher car distance plus longue depuis la rive gauche, paradoxalement). Paris RIVE DROITE ↔ Orly = 45 € ; Paris RIVE GAUCHE ↔ Orly = 36 € (moins cher, car Orly est au sud, donc plus proche de la rive gauche). Ces forfaits s'appliquent quelle que soit la durée réelle du trajet (embouteillages inclus) et ne sont pas négociables. Pièges classiques : ils ne s'appliquent pas si le client demande un détour, et ils ne couvrent pas les communes hors Paris.",
        keyPoints: [
          "A = Paris jour semaine (10h-17h) = le moins cher",
          "B = Paris nuit/dimanche/fériés OU banlieue jour",
          "C = dimanche nuit à Paris, banlieue nuit, au-delà de la zone",
          "PAS de tarif D à Paris — le D (retour à vide de nuit) n'existe qu'en province",
        ...
        confusionPoints: [
          "Paris = 3 tarifs (A, B, C) ≠ province = 4 tarifs (A, B, C, D)",
